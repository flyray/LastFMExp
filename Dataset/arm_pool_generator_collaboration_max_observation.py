...
# delicious
a = [24, 18, 121, 112, 99, 96, 26, 124, 97, 27, 118, 114, 61, 46, 34, 19, 192, 122, 111, 55, 167, 160, 134, 86, 81, 57,
     17, 10, 197, 176, 158, 133, 126, 113, 105, 93, 91, 87, 74, 64, 52, 39, 36, 16, 11, 9, 195, 193, 174, 168, 163, 150,
     145, 141, 123, 117, 108, 107, 103, 79, 68, 33, 22, 186, 183, 180, 172, 156, 154, 143, 136, 129, 100, 90, 83, 77,
     70, 65, 51, 49, 25, 20, 15, 14, 4, 199, 189, 188, 187, 185, 184, 182, 181, 179, 178, 169, 165, 164, 149, 147, 130,
     115, 110, 104, 95, 76, 59, 44, 28, 23, 8, 6, 5, 198, 190, 177, 175, 171, 170, 166, 155, 153, 148, 144, 140, 127,
     106, 88, 78, 58, 48, 38, 30, 12, 1, 196, 194, 191, 173, 161, 159, 157, 137, 135, 131, 120, 119, 102, 101, 85, 84,
     73, 72, 50, 43, 35, 162, 152, 151, 142, 138, 92, 82, 80, 66, 60, 45, 41, 37, 21, 7, 2, 139, 128, 98, 94, 89, 71,
     69, 56, 53, 42, 40, 32, 31, 29, 3, 132, 125, 109, 75, 67, 63, 62, 54, 47, 0, 146, 116, 13]
# a = a[:100]
print len(a)
...
fout_Part1 = open(
    sys.argv[1].split('/')[0] + '/processed_events_shuffled_' + 'select100' + '_max_observation_part1.dat', 'w')
fout_Part1.write('userid	timestamp	arm_pool\n')
fout_Part2 = open(
    sys.argv[1].split('/')[0] + '/processed_events_shuffled_' + 'select100' + '_max_oberservation_part2.dat', 'w')
