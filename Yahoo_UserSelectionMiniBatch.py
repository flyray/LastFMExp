...
if __name__ == '__main__':
	...
	fileSig = 'UserSelection_'+ str(DiagType)+str(clusterNum)+ 'SP'+ str(SparsityLevel)+algName+'batch_'+ str(userSelectionMiniBatch)+'_'
	batchSize = 2000
					...
					if len(MiniBatch_Lines) == userSelectionMiniBatch:
						...
						for i in range(len(MiniBatch_Lines)):
							...
							if algName == 'CoLin':
								...
								tim, article_chosen, click, currentUserID, pool_articles = parseLine_ID(CoLinUCBPickedLine)
							...
							if algName == 'GOBLin':
								...
								tim, article_chosen, click, currentUserID, pool_articles = parseLine_ID(GOBLinPickedline)
							...
							if algName == 'Uniform_LinUCB':
								...
								tim, article_chosen, click, currentUserID, pool_articles = parseLine_ID(UniformLinUCBPickedline)
							...
							if algName == 'LinUCB':
								...
								tim, article_chosen, click, currentUserID, pool_articles = parseLine_ID(LinUCBPickedline)
								#print click
