...
if __name__ == '__main__':
    ...
    parser.add_argument('--alg', dest='alg',
                        help='Select a specific algorithm, could be CoLinUCB, GOBLin, LinUCB, M_LinUCB, Uniform_LinUCB, or ALL. No alg argument means Random.')
    ...
    fileSig = args.dataset + '_' + args.alg + '_' + 'alpha' + args.alpha + '_alpha2' + args.alpha_2 + '_' + args.binaryRatio + '_' + \
              fileName.split('/')[3] + '_'
