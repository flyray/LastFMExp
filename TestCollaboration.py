...
if __name__ == '__main__':
    ...
    parser.add_argument('--alg', dest='alg',
                        help='Select a specific algorithm, could be CoLinUCB, GOBLin, LinUCB, M_LinUCB, Uniform_LinUCB, Hybrid_LinUCB, CLUB, or ALL.')
    ...
    fileSig = 'TestCo' + args.dataset + '_' + str(
        nClusters) + '_shuffled_Clustering_' + args.alg + '_Diagnol_' + args.diagnol + '_' + args.cut + '_'
    ...
    with open(FirstPartFileName, 'r') as f1:
        ...
        for line in f1:
            ...
            if runCoLinUCB:
                ...
                fout.write(str(CoLinUCBPicked) + ' ' + str(mean) + ' ' + str(var) + ' ' + str(
                    CoLinUCB_PickedfeatureVector) + '\n')
                fout.close()
            if runGOBLin:
