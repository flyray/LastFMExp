...
partition_arr = [['parallel', '16', '48:00:00', 'OMP_NUM_THREADS=16'],
                 ['serial', '1', '120:00:00', 'OMP_NUM_THREADS=8']]
...
for dataset in dataset_arr:
    for num in clusternum_arr:
        for alg in alg_arr[-2:]:
            ...
            t[-1] = partition[3] + t[-1] + ' --alg ' + alg + ' --dataset ' + dataset[0] + ' --clusterfile ' + dataset[
                1] + num + ' --diagnol ' + diagnol
