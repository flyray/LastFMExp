...
if __name__ == '__main__':
    ...
    def printWrite():
        ...
        if algName == 'CoLin':
            ...
            print totalObservations, CoLinMatchedNum
        ...
        if algName == 'GOBLin':
            ...
            print totalObservations, GOBLinMatchedNum
        ...
        if algName == 'LinUCB':
            ...
            print totalObservations, LinUCBMatchedNum
    ...
    fileSig = 'SelectUser_' + str(DiagType) + str(clusterNum) + 'SP' + str(SparsityLevel) + algName
    batchSize = 2000
    ...
    for dataDay in dataDays:
        ...
        with open(fileName, 'r') as f:
            ...
            for line in f:
                    ...
                    if len(article_featureVector) == 5:
                        if algName == 'CoLin':
                            for u in range(userNum):
                                CoLinUCB_pta = CoLinUCB_USERS.getProb(alpha, article_featureVector, u)
                                # print CoLinUCB_pta
                                if CoLinUCB_maxPTA < CoLinUCB_pta:
                                    ...
                                    CoLinUCBPickedUser = u
                                    CoLinUCB_maxPTA = CoLinUCB_pta
                        if algName == 'GOBLin':
                            for u in range(userNum):
                                GOBLin_pta = GOBLin_USERS.getProb(alpha, article_featureVector, u)
                        ...
                        if algName == 'LinUCB':
                            for u in range(userNum):
                                LinUCB_pta = LinUCB_users[u].getProb(alpha, article_featureVector)
                ...
                if algName == 'CoLin':
                    # print 'CoLinUCBPicked', CoLinUCBPicked, 'article_chosen', article_chosen, 'CoLinUCBPickedUser', CoLinUCBPickedUser, 'TrueUser', currentUserID, click
                    if CoLinUCBPicked == article_chosen and CoLinUCBPickedUser == currentUserID:
                        print CoLinUCBPickedUser, currentUserID, click
                        CoLinMatchedNum += 1
                        ...
                        calculateStat()
                if algName == 'GOBLin':
                    if GOBLinPicked == article_chosen and GOBLinPickedUser == currentUserID:
                        GOBLinMatchedNum += 1
                ...
                if algName == 'Uniform_LinUCB':
                    if UniformLinUCBPicked == article_chosen:
                        ...
                        calculateStat()
                if algName == 'LinUCB':
                    # print LinUCBPicked, article_chosen, LinUCBPickedUser, currentUserID
                    if LinUCBPicked == article_chosen and LinUCBPickedUser == currentUserID:
                        print LinUCBPickedUser, currentUserID, click
                        LinUCBMatchedNum += 1
