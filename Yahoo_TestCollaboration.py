...
if __name__ == '__main__':
    ...
    parser.add_argument('--max', action='store_true',
                        help="Max means max number of users in a cluster. Otherwise max observations in cluster.")
    ...
    fileSig = 'TestCoYahoo' + 'Opt' + str(clusterNum) + 'SP' + str(SparsityLevel) + algName
    batchSize = 2000
    ...
    if args.max:
        ...
        fileNameWriteCluster = os.path.join(Kmeansdata_address,
                                            '10kmeans_model' + '160' + '.dat' + '.80.max_observation')
